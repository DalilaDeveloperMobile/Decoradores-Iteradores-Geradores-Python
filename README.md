...
### <img src="https://gifs.eco.br/wp-content/uploads/2021/06/gifs-de-coracao-7.gif" width="30px"> Passagem Param:
```
def mensagem(nome):
...
```
### <img src="https://gifs.eco.br/wp-content/uploads/2021/06/gifs-de-coracao-7.gif" width="30px"> Função Interna:
```
def principal():
...
principal()
```
### <img src="https://gifs.eco.br/wp-content/uploads/2021/06/gifs-de-coracao-7.gif" width="30px"> Retorna Função:
```
...
print(op(2, 2))
```
### <img src="https://gifs.eco.br/wp-content/uploads/2021/06/gifs-de-coracao-7.gif" width="30px"> Primeiro Decorador:
```
...
ola_mundo()
```
### <img src="https://gifs.eco.br/wp-content/uploads/2021/06/gifs-de-coracao-7.gif" width="30px"> Decorador Com Argumentos:
```
def meu_decorador(funcao):
...
ola_mundo("João", 1000)
```
### <img src="https://gifs.eco.br/wp-content/uploads/2021/06/gifs-de-coracao-7.gif" width="30px"> Decorador Introspecção:
```
import functools
...
```
### <img src="https://gifs.eco.br/wp-content/uploads/2021/06/gifs-de-coracao-7.gif" width="30px"> Decorador Retorna Valor Func Decorada:
```
def meu_decorador(funcao):
    def envelope(*args, **kwargs):
        print("faz algo antes de executar")
...
print(ola_mundo)
```
### <img src="https://gifs.eco.br/wp-content/uploads/2021/06/gifs-de-coracao-7.gif" width="30px"> Iteradores:
```
class MeuIterador:
...
for i in MeuIterador(numeros=[38, 13, 11]):
    print(i)
```
### <img src="https://gifs.eco.br/wp-content/uploads/2021/06/gifs-de-coracao-7.gif" width="30px"> Geradores:
```
